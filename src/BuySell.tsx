...
import { computePoolKey, DEADLINE_SEC, getAmountOut, SWAP_FEE, withSlippage, ZAMMPoolKey } from "./lib/swap";
...
export const BuySell = ({
  ...
  const imageUrl =
    ...
    (coinData?.metadata?.image_url && formatImageURL(coinData.metadata.image_url)) ||
    (coinData?.metadata?.imageUrl && formatImageURL(coinData.metadata.imageUrl)) ||
    "";
