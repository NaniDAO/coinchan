...
function OrgPage() {
  ...
  return (
    <div className="container max-w-6xl mx-auto px-4 py-8 space-y-6">
      {/* Back Button */}
      <Link to="/explore/daicos" className="flex flex-row space-x-2 text-xs hover:underline">
        <ArrowLeft className="w-4 h-4 mr-2" />
      ...
      <Tabs defaultValue="sales" className="space-y-4">
        ...
        <TabsContent value="sales">
          <DAICOSalesTab sales={org.sales} explorerUrl={explorerUrl} fmtETH={fmtETH} fromEpoch={fromEpoch} />
        </TabsContent>
        ...
        {org.lps.length > 0 && (
          <TabsContent value="lps">
            <DAICOLPsTab lps={org.lps} explorerUrl={explorerUrl} fmtETH={fmtETH} fromEpoch={fromEpoch} />
          </TabsContent>
        )}
      </Tabs>
    </div>
