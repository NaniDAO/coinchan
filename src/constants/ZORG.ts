export const ZORG_RENDERER = "0x000000000011c799980827f52d3137b4abd6e654";
export const ZORG_RENDERER_ABI = [
  { inputs: [], stateMutability: "payable", type: "constructor" },
  {
    inputs: [
      { internalType: "contract IMoloch", name: "dao", type: "address" },
      { internalType: "uint256", name: "seatId", type: "uint256" },
    ],
    name: "badgeTokenURI",
  ...
  {
    inputs: [{ internalType: "contract IMoloch", name: "dao", type: "address" }],
    name: "daoContractURI",
    outputs: [{ internalType: "string", name: "", type: "string" }],
    stateMutability: "view",
    type: "function",
...
export const ZORG_ABI = [
  ...
  {
    inputs: [{ internalType: "uint64", name: "untilWhen", type: "uint64" }],
    name: "Timelocked",
    type: "error",
  },
  ...
  },
  {
    ...
    outputs: [
      {
        internalType: "enum Moloch.ProposalState",
        name: "",
        type: "uint8",
      },
    ],
...
export const ZORG_SHARES_ABI = [
  { inputs: [], stateMutability: "payable", type: "constructor" },
  { inputs: [], name: "BadBlock", type: "error" },
  { inputs: [], name: "Locked", type: "error" },
  { inputs: [], name: "SplitDupe", type: "error" },
  { inputs: [], name: "SplitLen", type: "error" },
  { inputs: [], name: "SplitSum", type: "error" },
  { inputs: [], name: "SplitZero", type: "error" },
  { inputs: [], name: "Unauthorized", type: "error" },
  {
    anonymous: false,
    inputs: [
  ...
  {
    inputs: [{ internalType: "uint48", name: "blockNumber", type: "uint48" }],
  ...
  },
  {
    inputs: [
      ...
      { internalType: "uint48", name: "blockNumber", type: "uint48" },
    ],
    name: "getPastVotes",
    outputs: [{ internalType: "uint256", name: "", type: "uint256" }],
    stateMutability: "view",
  ...
  },
  {
    inputs: [
      ...
      { internalType: "uint32[]", name: "bps_", type: "uint32[]" },
    ],
    name: "setSplitDelegation",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
  },
