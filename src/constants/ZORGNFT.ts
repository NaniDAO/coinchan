export const ZORG_NFT = "0x00000000008835ceF3E0D2333695f288Ee6b63A6";
export const ZORG_NFT_ABI = [
  ...
  { inputs: [], name: "NotRelatedHolder", type: "error" },
  ...
  },
  {
    ...
    outputs: [
      ...
      { internalType: "string", name: "expression", type: "string" },
      { internalType: "string", name: "mouth", type: "string" },
      { internalType: "string", name: "aura", type: "string" },
      { internalType: "string", name: "corruption", type: "string" },
      { internalType: "string", name: "sigil", type: "string" },
    ],
    stateMutability: "view",
    type: "function",
  },
  ...
  {
    inputs: [{ internalType: "string", name: "newDapp", type: "string" }],
    name: "setDapp",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
