...
import { getTrustWalletLogoUrl, fixTrustWalletLogoUrl } from "./checksum-address";
...
export function createErc20Token(
  ...
  const finalLogoURI = logoURI ? fixTrustWalletLogoUrl(logoURI) : getTrustWalletLogoUrl(address);
