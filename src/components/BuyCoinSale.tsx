    ...
    if (mode === "ETH") {
      try {
        ...
        if (mulmodResult !== 0n) {
          ...
          return {
            validEthAmount: validAmount,
            validCoinAmount: coinAmount,
            ethCost: validAmount,
            canPurchase: true,
          };
        }
      ...
      try {
        ...
        return {
          validEthAmount: ethCost,
          validCoinAmount: desiredCoins,
          ethCost,
          canPurchase: true,
        };
      } catch {
