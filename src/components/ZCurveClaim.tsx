      ...
      <CardContent className="space-y-4">
        <div className="space-y-2">
          <div className="flex justify-between text-sm">
            ...
            <span className="font-bold text-lg">{formatEther(claimableAmount)} {coinSymbol}</span>
          </div>
          
          {totalClaimed > 0n && (
            <div className="flex justify-between text-sm">
              <span className="text-muted-foreground">{t("claim.already_claimed", "Already Claimed")}</span>
              <span>{formatEther(totalClaimed)} {coinSymbol}</span>
            </div>
          )}
          
          <div className="flex justify-between text-sm">
            <span className="text-muted-foreground">{t("claim.total_purchased", "Total Purchased")}</span>
            <span>{formatEther(totalPurchased)} {coinSymbol}</span>
          </div>
        </div>
