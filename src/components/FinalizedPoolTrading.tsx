          ...
          <Tabs value={activeTab} onValueChange={(v) => setActiveTab(v as any)}>
            ...
            <TabsContent value="swap" className="mt-0">
              ...
              <div className="w-full">
                <div className="grid grid-cols-1 lg:grid-cols-5 gap-4 lg:gap-6 xl:gap-8">
                  {/* Chart Section - Desktop: Left, Mobile: Below swap */}
                  <div className="lg:col-span-3 order-2 lg:order-1 bg-card border border-border rounded-lg p-4 lg:p-6 xl:p-8">
                    <div className="h-full flex flex-col">
                      ...
                      <div
                        className={`flex-1 ${!showPriceChart && "lg:block hidden"}`}
                      >
                        <Suspense
                          fallback={
                  ...
                  <div className="lg:col-span-2 order-1 lg:order-2 bg-card border border-border rounded-lg p-4 lg:p-6 xl:p-8">
                    <div className="w-full">
                      {/* Token Metadata */}
                      <div className="mb-6">
                          ...
                          <div>
                            ...
                            <p className="font-medium">
                              {marketCapUsd > 0 ? (
                                <>
                                  {(
                                    marketCapUsd / (ethPrice?.priceUSD || 1)
                                  ).toFixed(2)}{" "}
                                  ETH
