...
export const LandingPage: React.FC<LandingPageProps> = ({ onEnterApp }) => {
  ...
  return (
    <div className="m-0 p-0">
      ...
      <div className="fixed inset-0 w-screen h-screen m-0 p-0 retro-grid pointer-events-none" style={{ zIndex: -10 }} />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-12 pb-20 lg:flex lg:gap-16 items-start">
          ...
          <div className="hidden lg:block w-1/3 pt-10 sticky top-24 self-start">
            <div className="font-mono text-xs sm:text-sm space-y-6 text-muted-foreground">
              {/* Title */}
              <div className="text-3xl font-black text-foreground tracking-tighter mb-6 font-sans">ZAMM DEFI</div>
              ...
              {systemReady && (
                <div className="pt-4 border-l-2 border-primary pl-4">
                  <p className="mb-2">
                    Cheapest Ethereum Exchange <span className="cursor-blink">_</span>
                  </p>
              ...
              <div className="space-y-1 font-bold">
                <div className="flex justify-between w-48">
                  <span>eth</span>
                  <span>{landingData?.ethPrice || "loading..."}</span>
                </div>
                <div className="flex justify-between w-48">
                  <span>{t("landing.gas")}</span>
                  <span>{landingData?.gasPrice || "loading..."}</span>
                </div>
                <div className="flex justify-between w-48">
                  <span>{t("landing.create")}</span>
                  <span>{landingData?.createCost || "loading..."}</span>
                </div>
              </div>
              ...
              <div className="space-y-2 font-bold pt-4 border-t border-border">
                <div className="flex flex-col">
                  ...
                  <span>{protocolStats?.totalEthSwapped || "loading..."}</span>
                </div>
                <div className="flex justify-between w-48">
                  <span>swaps</span>
                  <span>{protocolStats?.totalSwaps || "loading..."}</span>
                </div>
                <div className="flex justify-between w-48">
                  <span>coins</span>
                  <span>{protocolStats?.totalCoins || "loading..."}</span>
                </div>
              </div>

              {/* Predictions */}
              <div className="pt-6">
                <h3 className="font-bold text-foreground mb-3 text-base">{t("landing.predictions")}:</h3>
                <div className="space-y-2 border-l border-border ml-1 pl-3 relative">
                  <div className="flex items-center gap-2">
                    ...
                    >
                      <span className="font-bold text-foreground">ethPM</span>
                      <span className="opacity-50 text-[10px]">(Prediction Markets)</span>
                    </a>
                  </div>
                </div>
              </div>
              ...
              {/* Trending Farms */}
              <div className="pt-6">
                <h3 className="font-bold text-foreground mb-3 text-base">{t("landing.trending")}:</h3>
                <SortedTrendingFarms />
              </div>

              {/* Governance */}
              <div className="pt-6">
                <h3 className="font-bold text-foreground mb-3 text-base">{t("landing.governance")}:</h3>
                <GovernanceProposals />
              </div>
          ...
          <div className="w-full lg:w-2/3 space-y-12">
            ...
            <section className="max-w-2xl mx-auto lg:mx-0 relative">
              ...
              <div className="mb-8 flex items-center gap-4">
                ...
                <span className="px-2 py-1 bg-foreground text-background text-xs font-mono rounded">v1.0</span>
              </div>
              <div className="prose prose-lg dark:prose-invert text-muted-foreground font-sans leading-relaxed">
                <p className="mb-4 first-letter:text-5xl first-letter:font-bold first-letter:mr-3 first-letter:float-left first-letter:text-primary">
                  ZAMM is the cheapest decentralized exchange on Ethereum with a built-in DAICO launchpad. It enables{" "}
                  <span className="text-foreground font-semibold border-b-2 border-primary/30">
                    gas-optimized on-chain trading
                  </span>{" "}
                  and permissionless token launches using a next-generation market maker.
                </p>
                <p className="mb-6 text-base">
                  DAICOs on ZAMM allow projects to raise funds and create liquidity simultaneously, fully on-chain.
                </p>
                <div className="bg-card border-l-4 border-primary p-6 rounded-r-lg my-8 shadow-sm">
                  ...
                  <p className="text-base m-0">
                    Unlike traditional launchpads, ZAMM enforces{" "}
                    <span className="font-bold text-foreground">zero custody</span>, no whitelisting, and absolutely no
                    off-chain processes. It puts the power back into the hands of the community, ensuring true
                    decentralization and transparency from day one.
                  </p>
                </div>
                ...
                <p className="mt-8 text-base">
                  ZAMM is designed for developers, traders, and communities who want to launch and trade tokens directly
                  on Ethereum mainnet without relying on centralized launchpads or expensive AMMs.
                </p>
              </div>
            </section>
        ...
        <footer className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 border-t border-border mt-20">
          <div className="space-y-4">
            <p className="text-sm text-muted-foreground max-w-2xl">
              ZAMM is a decentralized exchange and DAICO launch protocol on Ethereum mainnet.
            </p>
