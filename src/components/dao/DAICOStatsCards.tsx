...
import { DollarSign, TrendingUp, Users, Droplet, Shield } from "lucide-react";
      ...
      {quorumBps !== undefined && (
        <Card className="p-4">
          <div className="flex items-start gap-3">
            ...
            <div>
              <div className="text-2xl font-bold">{(Number(quorumBps) / 100).toFixed(0)}%</div>
              <div className="text-sm text-muted-foreground">Voting Quorum</div>
            </div>
          </div>
        </Card>
      )}
