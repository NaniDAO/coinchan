        ...
        <div className="flex gap-4">
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="space-y-1.5">
              ...
              <div className="text-xs text-muted-foreground">Connect wallet to check eligibility</div>
            </div>
          </div>
        </div>
      </div>
  ...
  return (
    <div className="mb-4 p-4 border border-primary/30 rounded-lg bg-primary/5">
      ...
      <div className="space-y-3">
        ...
        <Button onClick={handleMint} disabled={isMinting || isSoldOut} className="w-full" size="sm">
          {isSoldOut ? (
            "Sold Out"
          ) : isMinting ? (
            <>
