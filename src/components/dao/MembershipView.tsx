...
export const MembershipView = () => {
  ...
  if (!isMember) {
    return (
      <div className="border border-white/20 rounded-lg p-8 bg-white/5 text-center space-y-4">
        ...
        <p className="text-xs text-white/50">Join the DAO to participate in governance and receive shares</p>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-6">
      <h3 className="text-xl font-semibold border-b border-white/20 pb-3">Your Membership</h3>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="p-6 border border-white/20 rounded-lg bg-white/5">
          ...
          <div className="text-xs text-white/50 mt-2">Tokens with voting rights</div>
        </div>
        ...
        <div className="p-6 border border-white/20 rounded-lg bg-white/5">
          ...
          <div className="text-xs text-white/50 mt-2">Economic shares (no voting)</div>
        </div>
        ...
        <div className="p-6 border border-white/20 rounded-lg bg-white/5">
          ...
          <div className="text-xs text-white/50 mt-2">Including delegations</div>
        </div>
      </div>
      ...
      {isDelegating && delegate && (
        <div className="p-4 border border-yellow-500/30 rounded-lg bg-yellow-500/5">
          ...
          <div className="text-xs text-white/70">You have delegated your voting power to:</div>
      ...
      <div className="border border-white/20 rounded-lg p-6 bg-white/5">
        ...
        <div className="text-xs text-white/60">Your unique DAO membership NFT badge will be displayed here</div>
