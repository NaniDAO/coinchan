...
export const DataNode = ({ label, icon: Icon, corner, delay, onClick, onHoverChange }: DataNodeProps) => {
    ...
    >
      <div className="relative">
        ...
        <motion.div
          ...
          animate={{
            borderColor: isHovered ? color.primary : "rgba(255,255,255,0.3)",
          }}
        ...
        >
          ...
          <motion.div
            ...
            animate={{
              color: isHovered ? color.primary : "rgba(0,0,0,0.8)",
