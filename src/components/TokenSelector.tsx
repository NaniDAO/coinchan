    ...
    return (
      <div className="relative">
        ...
        <div
          ...
          className={cn(
            "z-10 hover:bg-muted  rounded-md flex items-center gap-2 px-2 py-1 touch-manipulation border border-border transition-colors",
            ...
            <div className="bg-background z-10 content-visibility-auto intrinsic-h-[5000px] contain-content">
              {tokens.map((token) => {
                const isSelected =
                  ...
                  token?.token1 === selectedToken?.token1;
