...
const CHAOS_COLORS = ["text-red-400", "text-red-500", "text-red-600", "text-orange-500", "text-pink-500"];
...
export const CultChaosEffects = React.memo(
  ({
    ...
    return (
      <div
        className={cn("transition-all duration-1000", chaosColor)}
        style={{
...
export const CultLoadingChaos = () => {
  ...
  return (
    <div className="text-center py-8">
      <div className="text-2xl font-bold text-red-500 animate-pulse">LOADING CULT{dot}</div>
      <div className="mt-2 text-sm text-gray-500">Summoning the chaos</div>
    </div>
  );
};
