      ...
      <div className="p-6 border-b-2 border-border bg-gradient-to-r from-primary/5 to-transparent">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <h3 className="font-mono font-bold text-base sm:text-lg uppercase tracking-wider text-primary break-all">
              [{lpToken?.symbol}]
            </h3>
          </div>
          <div className="flex items-center gap-2">
            <div
              className={cn(
                "px-3 py-1.5 border-2 font-mono text-xs uppercase tracking-wider font-bold rounded",
                isActive
