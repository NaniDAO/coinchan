...
export default function PoolsTable({
    ...
    const rowsData: PoolTableItem[] = useMemo(() => {
        ...
        // @TODO Remove when indexer issue fixed
        ...
        () => [
            ...
            },
            {
                ...
                cell: ({ row }) => {
                    ...
                    const activeCount = poolId
                        ? activeIncentivesMap.get(poolId) || 0
                        : 0;
